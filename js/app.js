...
// Render do preview (com imagens responsivas)
function renderPreview() {
  ...
  // Nota: se imagens forem inseridas em alguma seção (por ex., logotipos de empresas),
  // garanta que recebam a classe Bootstrap 'img-fluid' no HTML injetado ou aplique CSS global:
  // #cvPreview img { max-width: 100%; height: auto; }
